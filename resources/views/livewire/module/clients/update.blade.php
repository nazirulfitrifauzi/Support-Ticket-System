                        ...
                        <div class="flex space-x-4">
                            <div class="relative inline-flex items-center justify-center w-3/12 text-white transition-all duration-200 w-19 text-size-base ease-soft-in-out rounded-xl">
                                <span class="relative inline-block">
                                    <img class="w-full h-full rounded-xl" src="/storage/{{ $client->logo }}" alt="">
                            ...
                            <div class="w-full pl-6">
                                <label class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80" for="Client's Code">Code @error('code') <span class="text-red-500">{{ $message }}</span> @enderror</label>
                                <div class="mb-4">
                                    <input wire:model.defer="code" type="text" name="Client's Code" placeholder="Client's Code" class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" required="" value="{{ $client->code }}">
                                </div>
                                <label class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80" for="Client's Name">Name @error('name') <span class="text-red-500">{{ $message }}</span> @enderror</label>
                                <div class="mb-4">
                                ...
                                <label class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80" for="Client's Address">Address @error('address') <span class="text-red-500">{{ $message }}</span> @enderror</label>
                                <div class="mb-4">
                                ...
                                <label class="inline-block mb-2 ml-1 font-bold text-size-xs text-slate-700 dark:text-white/80" for="Client's Contact No">Contact No @error('phone') <span class="text-red-500">{{ $message }}</span> @enderror</label>
                                <div class="mb-4">
